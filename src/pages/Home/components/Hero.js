...
export const Hero = () => {
  return (
    <section className="max-w-7xl m-auto flex flex-col mt-24 lg:flex-row dark:text-slate-100 items-center">
        ...
        <div className="custom-shape-divider-top-1714969596 dark:custom-shape-divider-top-1714969596-dark">
