...
import { ProductDetails } from "../service/ProductService";
        ...
        <section>
          ...
          <div className="flex flex-wrap justify-around">
            ...
            <div className="max-w-xl my-3">
              ...
              <p className="my-3">
                { !product.in_stock && <button onClick={() => addToCart(product)} className={`cursor-not-allowed inline-flex items-center py-2 px-5 text-lg font-medium text-center text-white bg-blue-500 rounded-lg hover:bg-blue-400`} disabled>Add To Cart <i className="ml-1 bi bi-plus-lg"></i></button> }
