...
export const ProductCard = ({product}) => {
    ...
    const {id, name, overview, poster, image_local, price, rating, best_seller, in_stock} = product;
    ...
    <div className="m-3 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="p-5">
            ...
            <p className="flex justify-between items-center">
                ...
                { !in_stock && <button onClick={() => addToCart(product)} className="cursor-not-allowed inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-500 rounded-lg hover:bg-blue-400" disabled>Add To Cart <i className="ml-1 bi bi-plus-lg"></i></button> }
